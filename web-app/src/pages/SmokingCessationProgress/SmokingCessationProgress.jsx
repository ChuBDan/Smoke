...
const SmokingCessationProgress = () => {
  ...
  const handleSubmitProgress = async (day) => {
    if (loadingSubmit) return;
    setLoadingSubmit(true);
    try {
      const daysSmokeFree = 1;
      const healthImprovement = "Good";
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-blue-50">
        <div className="text-center">
          <div className="animate-spin h-12 w-12 rounded-full border-b-2 border-green-600 mx-auto mb-4"></div>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-blue-50">
        <div className="text-center bg-white p-8 rounded-2xl shadow-xl">
          ...
          <p className="text-gray-600 mb-4">
            No plan found. Go back & create one.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="text-center relative">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Your personalized path to a smoke-free life. Each phase is
              designed to support your journey with daily goals, tasks, and
              tips.
            </p>
          </div>
        </div>
              ...
              {calendar[activePhase]?.map((day, dIdx) => {
                ...
                return (
                  <DayCard
                    ...
                    onSubmit={() => handleSubmitProgress(day)}
                  />
                );
              })}
            </div>
